    ...
    dictConfig(
        {
            ...
            "loggers": {
                ...
                "databases": {"hanlders": ["default"], "level": "WARNING"},
...
## root.connectofyne.routers.post
## propagate = false - don't propagate to root, so connectofyne is the top level
